...
export class BaseBasicSysAbstraction {
  ...
  readonly _idService: IdService = IdService.create();
  readonly _randomService: RandomService = RandomService.create(RandomMode.RANDOM);
